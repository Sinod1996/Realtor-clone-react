                ...
                <div className={'w-full md:w-[50%] mt-6 px-3'}>
                    <form>
                        ...
                        <input
                            ...
                            className={`mb-6 w-full px-4 py-2 text-xl text-gray-600 bg-white border border-gray-300 rounded 
                    ...
                    <button type={'button'} className={'w-full bg-blue-600 text-white uppercase px-7 py-3 text-sm font-medium rounded shadow-md ' +
