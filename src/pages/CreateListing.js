            ...
            <form>
                ...
                <div className={'flex'}>
                    <button
                        ...
                        id={'type'}
                        value={'sale'}
                        className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-ld active:shadow-lg
                    ...
                    <button
                        ...
                        id={'type'}
                        value={'sale'}
                        className={`ml-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-ld active:shadow-lg
                        transition duration-150 ease-in-out w-full ${
                ...
                <p className={'ext-lg mt-6 font-semibold '}>Name</p>
                <input
                    type="text"
                    id={'name'}
                    value={name}
                ...
                <p className={'ext-lg mt-6 font-semibold '}>Address</p>
                <textarea
                    type="text"
                    id={'address'}
                    value={address}
                    ...
                    className={'w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded' +
                        'transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6'}
                />
                <p className={'ext-lg mt-6 font-semibold '}>Description</p>
                <textarea
                    type="text"
                    id={'description'}
                    value={description}
                ...
                <button
                    type={'submit'}
                    className={'w-full mb-6 px-7 py-3 bg-blue-600 bg-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg ' +
                        'focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out text-white'}
                >
                    Create Listing
                </button>
            </form>
